...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: Bu kod satırı 'musadenemeDataSet.Table_Personel' tablosuna veri yükler. Bunu gerektiği şekilde taşıyabilir, veya kaldırabilirsiniz.
            this.table_PersonelTableAdapter.Fill(this.musadenemeDataSet.Table_Personel);
        }
        ...
        {
            Formİstatistik frm2 = new Formİstatistik();
            frm2.Show();
            this.Hide();
        }
